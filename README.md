...
To develop this Electron app, we needed some UI, test, formatter, style and other kind of library/framework.
...
```bash
git clone https://github.com/avell-labs/nexus.git
```
...
Now you can go directly to `/src/routes/index.tsx` and add new features to the app as you want.
